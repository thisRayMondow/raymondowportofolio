...
<head>
    ...
    <title>BS4xPHP Native | Session Login</title>
...
<body class="bg-info">
    <div class="container-fluid">
        <div class="d-flex justify-content-center m-5 p-3">
            <form action="/public/BS4xPHP/Session Login/validate/" method="post" class="bg-light">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="Default: admin, user" required autofocus maxlength="20">
                </div>

                <div class="form-group">
                    <label bel for="pass"><small class="text-danger">*</small> Kata Sandi : </label>
                    <input type="password" name="pass" id="pass" class="form-control" placeholder="Default: admin, 123" required autofocus maxlength="10">
                </div>
