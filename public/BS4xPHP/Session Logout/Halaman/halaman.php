...
<body class="bg-info">
    <div class="card-footer text-center bg-light mb-2">
        <nav class="navbar navbar-light">
            <a class="navbar-brand bg-info p-2" href="/public/BS4xPHP/Session Logout/Halaman/">CnG</a>
    ...
    <div class="content">
        <div class="sidebar" id="sidebar">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                	<a class="nav-link text-dark" href="/public/BS4xPHP/Session Logout/Out/"> <?php echo $_SESSION["pengguna"]?> (keluar)</a>
                </li>
            </ul>
        </div>
