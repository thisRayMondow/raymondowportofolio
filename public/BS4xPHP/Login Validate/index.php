    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-center m-5 p-3">
            <form action="" method="post" class="bg-light">
                ...
                <?php 
                if ($code == 101) {
                    echo '<small class="form-text text-danger">Nama Pengguna atau Kata Sandi Salah</small>';                        
                }
                ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="pass" id="pass" class="form-control" placeholder="Default: admin123" required autofocus maxlength="10">
                </div>
