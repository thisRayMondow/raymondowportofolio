...
<head>
    ...
    <title>BS4xPHP Native | UD Database</title>
...
<body class="pl-2 pr-2 bg-info">
    <div class="card p-3" style="overflow-x: scroll;">
        <h4> <a href="/public/BS4xPHP/UD Database" style="text-decoration: none;" data-toggle="tooltip" data-placement="bottom" title="Muat Ulang">&#128260;</a> Data Pengguna</h4>
        ...
        <button type="button" name="" id="" class="btn btn-primary btn-sm" style="width: 150px;">
        <strong>&plus;</strong>
